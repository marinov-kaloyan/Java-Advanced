...
public class E06_WordCount {
    public static void main(String[] args) throws IOException {
        Path words = Paths.get("D:\\04. Java-Advanced-Files-and-Streams-Exercises-Resources\\words.txt");
        Path text = Paths.get("D:\\04. Java-Advanced-Files-and-Streams-Exercises-Resources\\text.txt");
        String results = "D:\\04. Java-Advanced-Files-and-Streams-Exercises-Resources\\results.txt";
